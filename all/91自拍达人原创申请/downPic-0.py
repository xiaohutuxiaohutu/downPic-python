...
file=open("G:/down/91porn/all/91自拍达人原创申请/ALL12019-02-17_0.txt")
...
for num,value in enumerate(file,1):
    ...
    if len(imgUrls)==0 and len(imgUrls1)==0 and len(imgUrls2)==0:
        os.chdir('G:/down/91porn/all/91自拍达人原创申请/')
        ...
        path='G:/down/91porn/all/91自拍达人原创申请/'+datetime.datetime.now().strftime('%Y-%m-%d')+'/'+str(newTitle.strip())+'/'
        ...
        for i in range(0,len(imgUrls)):
            ...
            print('下载 imgUrls 第'+str(i+1)+'个:'+fileUrl)
        ...
        for i in range(0,len(imgUrls1)):
            ...
            print('下载imgUrls1第'+str(i+1)+'个:'+fileUrl1)
        ...
        for i in range(0,len(imgUrls2)):
            ...
            print('下载 imgUrls2 第'+str(i+1)+'个:'+fileUrl2)
