...
file=open("D:/TP/91/all/91自拍达人原创申请/2019-04-27_0.txt")
ip_list=get_ip_list(proxyipurl)
preUrl='http://92.e1fun.com/'
#获取总行数
for num,value in enumerate(file,1):
    ...
    if len(imgUrls)==0 and len(imgUrls1)==0 and len(imgUrls2)==0:
        ...
        path='D:/TP/91/all/91自拍达人原创申请/'+datetime.datetime.now().strftime('%Y-%m-%d')+'/'+str(newTitle.strip())+'/'
        ...
        for i in range(0,len(imgUrls)):
            ...
            #fileUrl='https://91dizhi-at-gmail-com-0403.w19.rocks/'+fileUrl
